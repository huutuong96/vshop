...
function CheckoutByshopItem({ s, index, setVoucherSelected, vouchersSelected, setCheckoutItems }: { s: any, index: number, setVoucherSelected: Dispatch<SetStateAction<any[]>>, vouchersSelected: any[], setCheckoutItems: Dispatch<SetStateAction<any[]>> }) {
...
export default React.memo(CheckoutByshopItem)